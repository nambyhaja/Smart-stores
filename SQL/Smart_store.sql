...
/* Date de création :  2019-03-03 06:51:03 PM                   */
/*==============================================================*/


drop index ASSOC_BC_CLIENT_FK;

drop index BC_PK;

drop table BC;

drop index ASSOC_BL_LIVREUR_FK;

drop index ASSOC_FACTURE_BL_FK;
...
drop index ASSOC_DETAICOMMANDE_BC_FK;

drop index ASSOC_PRODUIT_DETAILCOMMANDE_FK;

drop index DETAILCOMMANDE_PK;

drop table DETAILCOMMANDE;

drop index ASSOC_BC_FACTURE_FK;
...
drop index ASSOC_PRODUIT_PRIX_FK;

drop index PRIX_PK;

drop table PRIX;

drop index ASSOC_PRODUIT_CATEGORIE_FK;
...
drop table STATUSLIVRAISON;

drop index ASSOC_STOCK_PRODUIT_FK;

drop index STOCK_PK;

drop table STOCK;

drop index ASSOC_PRODUIT_TVA_FK;

drop index TVA_PK;

drop table TVA;

drop index VENDEUR_PK;
